...
num_q, num_pos, num_imp, train_contexts, train_questions, train_answers = loadData('/content/gdrive/MyDrive/HW3/Spoken-SQuAD-master/spoken_train-v1.1.json')
num_questions  = num_q
num_posible = num_pos
num_imposible  = num_imp

num_q, num_pos, num_imp, valid_contexts, valid_questions, valid_answers = loadData('/content/gdrive/MyDrive/HW3/Spoken-SQuAD-master/spoken_test-v1.1.json')
