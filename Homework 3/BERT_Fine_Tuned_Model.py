...
num_q, num_pos, num_imp, train_contexts, train_questions, train_answers = get_data('/content/gdrive/MyDrive/HW3/Spoken-SQuAD-master/spoken_train-v1.1.json')
num_questions  = num_q
num_posible = num_pos
num_imposible  = num_imp

num_q, num_pos, num_imp, valid_contexts, valid_questions, valid_answers = get_data('/content/gdrive/MyDrive/HW3/Spoken-SQuAD-master/spoken_test-v1.1.json')
...
train_encodings_fast = tokenizerFast(train_questions, train_contexts_trunc,  max_length = MAX_LENGTH,truncation=True,stride=doc_stride,
        padding=True)
...
print('WER (after applying fine-tned model) - ',wer_list)