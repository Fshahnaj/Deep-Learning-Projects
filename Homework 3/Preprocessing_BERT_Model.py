...
train_data_path = '/content/gdrive/MyDrive/HW3/Spoken-SQuAD-master/spoken_train-v1.1.json'
test_data_path = '/content/gdrive/MyDrive/HW3/Spoken-SQuAD-master/spoken_test-v1.1.json'
fig_save_path = 'figs'
