...
def data_preprocess():
    filepath = '/content/gdrive/MyDrive/hw2_hw2_1/training_data/'
...
def annotate(label_file, word_dict, w2i):
    label_json = '/content/gdrive/MyDrive/hw2_hw2_1/training_data/' + label_file
    annotated_caption = []
...
def avi(files_dir):
    avi_data = {}
    training_feats = '/content/gdrive/MyDrive/hw2_hw2_1/training_data/' + files_dir
...
def main():
    ...
    with open('/content/gdrive/MyDrive/hw2_hw2_1/i2w.pickle', 'wb') as handle:
    ...
    train_dataloader = DataLoader(dataset = train_dataset, batch_size=128, shuffle=True, num_workers=2, collate_fn=minibatch)
    ...
    save_dir = "/content/gdrive/MyDrive/hw2_hw2_1/SavedModel"
